  ...
  return (
    <div>
      <div style={{ marginBottom: '16px' }}>
        <div style={{ fontFamily: 'Syne, sans-serif', fontSize: '22px', color: '#1B3A2D', fontWeight: 800 }}>Room Availability</div>
        <div style={{ fontSize: '12px', color: '#718096' }}>Select dates and hotel to see available rooms</div>
      </div>
