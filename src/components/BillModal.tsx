        ...
        <div style={{ padding: '16px 20px', overflowY: 'auto', flex: 1 }}>
          ...
          <div id="bill-content" style={{ background: '#fff', border: '2px dashed #D1DDD4', borderRadius: '12px', padding: '24px', marginBottom: '16px', fontFamily: 'Inter, sans-serif' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '20px' }}>
              <div>
                <div style={{ fontFamily: 'Syne, sans-serif', fontSize: '18px', color: '#1B3A2D', fontWeight: 800, letterSpacing: 0 }}>Happy &amp; Panorama</div>
                <div style={{ fontSize: '11px', color: '#718096' }}>Groups of Hotel</div>
              </div>
            ...
            <div style={{ marginTop: '16px', paddingTop: '12px', borderTop: '1px solid #EAF0EC', fontSize: '11px', color: '#718096', textAlign: 'center' }}>
              Thank you for choosing {b.hotel.name}! | Happy &amp; Panorama Groups of Hotel | Ref: {b.bookingRef}
            </div>
          </div>
